import { OBJECT_PIXELS } from 'client/components/games/survivalOnline/SurvivalOnlineGame/components/GameContent/constants/objectPixels';

import { BiomeType, Cell, ObjectType } from 'common/types/games/survivalOnline';

import renderEyes from 'client/components/games/survivalOnline/SurvivalOnlineGame/components/GameContent/utilities/renderEyes';
import renderObject from 'client/components/games/survivalOnline/SurvivalOnlineGame/components/GameContent/utilities/renderObject';
