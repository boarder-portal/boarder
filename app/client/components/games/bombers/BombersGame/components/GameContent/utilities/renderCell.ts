...
import renderBomb from 'client/components/games/bombers/BombersGame/components/GameContent/utilities/renderBomb';
import renderBonus from 'client/components/games/bombers/BombersGame/components/GameContent/utilities/renderBonus';
import renderBox from 'client/components/games/bombers/BombersGame/components/GameContent/utilities/renderBox';
import renderCellImage from 'client/components/games/bombers/BombersGame/components/GameContent/utilities/renderCellImage';
import renderWall from 'client/components/games/bombers/BombersGame/components/GameContent/utilities/renderWall';
