...
import {
  CourtesansBuildInfo,
  OwnerResource,
} from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/types';
...
import { TradeVariant } from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/utilities/getTradeVariantsByPurchaseVariants';
...
import BuildActions from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/components/Actions/components/BuildActions/BuildActions';
import CancelAction from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/components/Actions/components/CancelAction/CancelAction';
import CourtesanAction from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/components/Actions/components/CourtesanAction/CourtesanAction';
import DraftLeaderActions from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/components/Actions/components/DraftLeaderAction/DraftLeaderAction';
