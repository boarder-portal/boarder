...
import Card from 'client/components/games/sevenWonders/SevenWondersGame/components/Card/Card';
import Actions from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/components/Actions/Actions';
