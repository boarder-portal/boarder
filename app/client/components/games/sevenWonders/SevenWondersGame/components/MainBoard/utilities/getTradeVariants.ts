...
import getPurchaseVariants from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/utilities/getPurchaseVariants';
import getTradeVariantsByPurchaseVariants, {
  TradeVariant,
} from 'client/components/games/sevenWonders/SevenWondersGame/components/MainBoard/components/HandCard/utilities/getTradeVariantsByPurchaseVariants';
