...
import Board from 'client/components/games/machiKoro/MachiKoroGame/components/MachiKoroGameContent/components/Board/Board';
import Player from 'client/components/games/machiKoro/MachiKoroGame/components/MachiKoroGameContent/components/Player/Player';
import StatusAndActions from 'client/components/games/machiKoro/MachiKoroGame/components/MachiKoroGameContent/components/StatusAndActions/StatusAndActions';

import { NEW_TURN, playSound } from 'client/sounds';

import styles from './MachiKoroGameContent.module.scss';
...
const MachiKoroGameContent: FC<GameContentProps<GameType.MACHI_KORO>> = (props) => {
...
export default memo(MachiKoroGameContent);
