...
import getPlayerPosition from 'client/components/games/hearts/HeartsGame/utilities/getPlayerPosition';
...
import Player from 'client/components/games/hearts/HeartsGame/components/Player/Player';
