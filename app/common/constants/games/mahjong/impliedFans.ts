...
export const IMPLIED_FANS: Partial<Record<EFan, EFan[]>> = {
  ...
  [EFan.ALL_GREEN]: [EFan.HALF_FLUSH],
  [EFan.NINE_GATES]: [EFan.FULL_FLUSH, EFan.CONCEALED_HAND, EFan.PUNG_OF_TERMINALS_OR_HONORS, EFan.NO_HONORS],
  [EFan.FOUR_KONGS]: [EFan.THREE_KONGS, EFan.TWO_MELDED_KONGS, EFan.MELDED_KONG, EFan.ALL_PUNGS, EFan.SINGLE_WAIT],
  ...
  [EFan.THIRTEEN_ORPHANS]: [EFan.ALL_TYPES, EFan.CONCEALED_HAND, EFan.SINGLE_WAIT],

  // 64 points
  [EFan.ALL_TERMINALS]: [EFan.ALL_PUNGS, EFan.OUTSIDE_HAND, EFan.PUNG_OF_TERMINALS_OR_HONORS, EFan.NO_HONORS],
  ...
  [EFan.ALL_HONORS]: [EFan.ALL_PUNGS, EFan.PUNG_OF_TERMINALS_OR_HONORS, EFan.OUTSIDE_HAND],
  ...
  // 48 points
  [EFan.QUADRUPLE_CHOWS]: [EFan.PURE_TRIPLE_CHOW, EFan.PURE_DOUBLE_CHOW, EFan.TILE_HOG],
  [EFan.FOUR_PURE_SHIFTED_PUNGS]: [EFan.PURE_SHIFTED_PUNGS, EFan.ALL_PUNGS],

  // 32 points
  [EFan.FOUR_PURE_SHIFTED_CHOWS]: [EFan.PURE_SHIFTED_CHOWS],
  [EFan.THREE_KONGS]: [EFan.TWO_MELDED_KONGS, EFan.MELDED_KONG],
