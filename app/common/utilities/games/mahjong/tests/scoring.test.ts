      ...
      test('half flush', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('We'), parsePung('Ws')],
      ...
      test('honors', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseKong('We', SetConcealedType.CONCEALED), parsePung('Ws')],
      ...
      test('half flush', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dr'), parsePung('Dg'), parsePung('Dw')],
      ...
      test('terminals', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dr'), parsePung('Dg'), parsePung('Dw'), parsePung('d9')],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...
              isSelfDraw: false,
              roundWind: WindSide.WEST,
              seatWind: WindSide.WEST,
            }),
          ),
        ).toMatchSnapshot();
      });
      ...
      test('pure shifted pungs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b2'), parsePung('b3'), parsePung('b4')],
      ...
      test('triple chow', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseChow('b3'), parseChow('b3'), parseChow('b3'), parsePung('b8')],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [
                parseKong('b3', SetConcealedType.CONCEALED),
                parseKong('c5', SetConcealedType.MELDED),
                parseKong('d8', SetConcealedType.MELDED),
                parseKong('Dr', SetConcealedType.MELDED),
              ],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...
              declaredSets: [
                parseKong('Dr', SetConcealedType.MELDED),
                parseKong('Dg', SetConcealedType.MELDED),
                parseKong('Dw', SetConcealedType.MELDED),
                parseKong('Wn', SetConcealedType.MELDED),
              ],
              hand: parsePlayableTiles('We'),
              isSelfDraw: false,
            }),
      ...
      test('double pung x2', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('d1'), parsePung('b1')],
      ...
      test('triple pung', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b9'), parsePung('d9'), parsePung('c9'), parsePung('d1')],
              hand: parsePlayableTiles('b1'),
              isSelfDraw: false,
            }),
          ),
      ...
      test('half flush', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('We'), parsePung('Ws'), parsePung('Ww')],
      ...
      test('pung of terminals', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dr'), parsePung('Dw')],
      ...
      test('all terminals and honors', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dw'), parsePung('Dg'), parsePung('b1'), parsePung('b9')],
      ...
      test('big three winds', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Ww'), parsePung('We'), parsePung('Wn')],
      ...
      test('little three dragons', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dr'), parsePung('Dg'), parsePung('We'), parsePung('Ww')],
      ...
      test('lower four', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b1'), parsePung('b2'), parsePung('b3')],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [
                parseKong('c8', SetConcealedType.MELDED),
                parseKong('c7', SetConcealedType.CONCEALED),
                parseKong('b9', SetConcealedType.CONCEALED),
              ],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [
                parseKong('Ww', SetConcealedType.MELDED),
                parseKong('Dr', SetConcealedType.CONCEALED),
                parseKong('c9', SetConcealedType.CONCEALED),
              ],
      ...
      test('double pung', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b4'), parsePung('d6')],
      ...
      test('triple pung', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b6'), parsePung('d6'), parsePung('c6')],
      ...
      test('half flush', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('c1'), parsePung('c2')],
      ...
      test('pure shifted pungs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('c4'), parsePung('c5')],
      ...
      test('mixed shifted pungs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('d1'), parsePung('c2'), parsePung('b3'), parsePung('c3')],
      ...
      test('bcd', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseChow('b2'), parseChow('b8')],
      ...
      test('all simples', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b4'), parsePung('c4'), parsePung('d4')],
      ...
      test('all pungs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('c3'), parsePung('b3')],
      ...
      test('one voided suit', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Ww'), parsePung('Wn'), parsePung('Ws')],
      ...
      test('all fives', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseChow('d4'), parseChow('d4')],
      ...
      test('all pungs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b8'), parsePung('d8')],
      ...
      test('no honors', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('d6'), parsePung('c7'), parsePung('b8')],
      ...
      test('all pungs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b3'), parsePung('c4'), parsePung('d5'), parsePung('b5')],
              hand: parsePlayableTiles('d2'),
              isSelfDraw: false,
            }),
          ),
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseChow('d2'), parsePung('b7'), parsePung('c8')],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseKong('c7', SetConcealedType.MELDED)],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...
              declaredSets: [
                parsePung('c7'),
                parseKong('b1', SetConcealedType.CONCEALED),
                parseKong('b2', SetConcealedType.CONCEALED),
              ],
              hand: parsePlayableTiles('c8c8c8c9'),
              winningTile: parsePlayableTile('c7'),
              lastTileCandidates: [parsePlayableTile('c7')],
            }),
          ),
        ).toMatchSnapshot();
      });
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('c8'), parsePung('b8'), parsePung('d8')],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...
              declaredSets: [
                parsePung('b8'),
                parseKong('c2', SetConcealedType.MELDED),
                parsePung('c7'),
                parseChow('c6'),
              ],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dr'), parseKong('Dg', SetConcealedType.MELDED)],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...
              declaredSets: [
                parsePung('Dr'),
                parseKong('d4', SetConcealedType.MELDED),
                parseKong('c4', SetConcealedType.MELDED),
              ],
      ...
      test('melded + concealed kongs', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseKong('c1', SetConcealedType.MELDED), parseKong('c2', SetConcealedType.CONCEALED)],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseChow('b2'), parsePung('b8')],
              hand: parsePlayableTiles('b3b4b5 c1c1 b6b7'),
              winningTile: parsePlayableTile('b8'),
              isSelfDraw: false,
              lastTileCandidates: [parsePlayableTile('b8')],
            }),
          ),
        ).toMatchSnapshot();
      });
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('We'), parsePung('Dr')],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Ws'), parsePung('d3')],
              hand: parsePlayableTiles('d4d4 d5d6d7 WeWe'),
              winningTile: parsePlayableTile('d4'),
              roundWind: WindSide.SOUTH,
              seatWind: WindSide.SOUTH,
            }),
          ),
        ).toMatchSnapshot();
      });
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('b5'), parsePung('c5')],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('d6'), parsePung('b7'), parseKong('c5', SetConcealedType.CONCEALED)],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('d1'), parsePung('c1')],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parseKong('d1', SetConcealedType.MELDED)],
      ...
      test('basic', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dg'), parseChow('d3')],
      ...
      test('shouldn\'t be included when for multiple sets', () => {
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...standardOptions,
              declaredSets: [parsePung('Dg'), parsePung('Dr')],
        ...
        expect(
          stringifyMahjong(
            getHandMahjong({
              ...
              flowers: parseTiles('f2f7') as FlowerTile[],
              winningTile: parsePlayableTile('d3'),
            }),
          ),
        ).toMatchSnapshot();
